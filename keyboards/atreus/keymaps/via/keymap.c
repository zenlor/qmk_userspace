...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_RS] = LAYOUT( /* [> RAISE <] */
    ...
    TG(_LW), KC_INS,  KC_LGUI, KC_LSFT, KC_DEL,  KC_LALT, KC_LCTL, KC_SPC,  KC_TRNS, KC_DOT, KC_0, KC_EQL  ),
  /*
  ...
  [_LW] = LAYOUT( /* [> LOWER <] */
    ...
    TO(_QW), KC_VOLD, KC_LGUI, KC_LSFT, KC_BSPC,   KC_LALT, KC_LCTL, KC_SPC,  TO(_QW), KC_PSCR, KC_SLSH, KC_PAUS ),
};
